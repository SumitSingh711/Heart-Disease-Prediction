...
You can access the heart disease predictor web application [here]([url](https://heart-disease-prediction-xaavvcgce2wpmd4fay9wv4.streamlit.app/)). Enter your health information such as age, cholesterol, and blood pressure to get an instant prediction.
